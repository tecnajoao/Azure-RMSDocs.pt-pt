...
description: "Conheça as aplicações que suportam nativamente o Azure RMS, o que significa que o RMS está totalmente integrado nestas aplicações ao utilizar as APIs de RMS para suportar restrições de utilização."
author: cabailey
manager: mbaldwin
ms.date: 08/25/2016
