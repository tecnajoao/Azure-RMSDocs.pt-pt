...
description: "Verifique se tem tudo pronto para ativar e implementar o Azure RMS, incluindo contas de utilizador e grupos para autenticação."
author: cabailey
manager: mbaldwin
ms.date: 08/25/2016
ms.topic: article
...
# Preparing for Azure Rights Management (Preparar para o Azure Rights Management – em inglês)
