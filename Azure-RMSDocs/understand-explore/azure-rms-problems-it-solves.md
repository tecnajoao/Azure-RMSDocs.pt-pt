...
> [!TIP]
> Se estiver familiarizado com a versão no local do Rights Management, os Serviços de Gestão de Direitos do Active Directory (AD RMS), poderá estar interessado na tabela de comparação do tópico [Comparar o Azure Rights Management e o AD RMS](compare-azure-rms-ad-rms.md).
