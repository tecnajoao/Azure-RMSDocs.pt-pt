...
description: "Um guia para o ajudar a implementar e utilizar o Azure Rights Management (Azure RMS) mais rapidamente para proteger os dados da sua organização. Comece por escolher uma lista de cenários específicos a implementar."
author: cabailey
manager: mbaldwin
ms.date: 08/25/2016
