...
description: "Como administrador, como sabe se os seus utilizadores se inscreveram no RMS para indivíduos? Pode utilizar qualquer um ou uma combinação dos seguintes métodos."
author: cabailey
manager: mbaldwin
ms.date: 08/24/2016
ms.topic: article
