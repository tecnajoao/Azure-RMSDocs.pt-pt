...
## Para instalar o cliente do Azure Information Protection manualmente
...
## Para instalar o cliente do Azure Information Protection para os utilizadores
...
2. Na caixa de diálogo **Microsoft Azure Information Protection**, tenha em consideração o seguinte:
    ...
    - Versão do cliente do Azure Information Protection.
