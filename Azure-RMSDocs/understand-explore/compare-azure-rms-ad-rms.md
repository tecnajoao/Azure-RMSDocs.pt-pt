...
[!INCLUDE[aad_rightsmanagement_1](../includes/aad_rightsmanagement_1_md.md)] está em conformidade com FIPS 140-2 quando a sua chave de inquilino é criada e gerida pela Microsoft (predefinição), ou se gerir a sua própria chave de inquilino (a solução BYOK). Para obter mais informações sobre a gestão da chave de inquilino, consulte [Planear e implementar a sua chave de inquilino do Azure Rights Management](../plan-design/plan-implement-tenant-key.md).
