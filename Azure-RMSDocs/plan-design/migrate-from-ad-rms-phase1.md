...
description: "Fase 1 da migração do AD RMS para o Azure Rights Management (Azure RMS), abrangendo os passos 1 a 4 de Migrar do AD RMS para o Azure Rights Management."
author: cabailey
manager: mbaldwin
ms.date: 08/25/2016
ms.topic: article
