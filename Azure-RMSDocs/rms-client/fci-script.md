...
description: "Esta página contém o script de amostra para copiar e editar, conforme descrito em Proteção RMS com Infraestrutura de Classificação de Ficheiros do Windows Server."
author: cabailey
manager: mbaldwin
ms.date: 08/24/2016
ms.topic: article
