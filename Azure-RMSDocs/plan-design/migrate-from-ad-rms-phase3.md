...
description: "Fase 3 da migração do AD RMS para o Azure Rights Management (Azure RMS), abrangendo os passos 6 a 7 de Migrar do AD RMS para o Azure Rights Management."
author: cabailey
manager: mbaldwin
ms.date: 08/17/2016
ms.topic: article
