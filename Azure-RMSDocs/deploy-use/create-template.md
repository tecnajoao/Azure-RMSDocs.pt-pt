...
1.  Consoante opte por iniciar sessão no centro de administração do Office 365 ou no portal clássico do Azure, efetue um dos seguintes procedimentos:
    ...
    -   No **Centro de administração do Office 365**, pode ir diretamente para a página [gestão de direitos](https://account.activedirectory.windowsazure.com/RmsOnline/Manage.aspx): 
    ...
    -   No [portal clássico do Azure](http://go.microsoft.com/fwlink/p/?LinkID=275081):
        ...
        3. Se o **ESTADO DO RIGHTS MANAGEMENT** apresentar **Inativo**, clique em **ATIVAR** e confirme a ação.

            > [!NOTE]
            > Para mais informações, consulte [Ativar o Azure Rights Management](activate-service.md)
            >
        4. Quando o **ESTADO DO RIGHTS MANAGEMENT** apresentar **Ativo**, selecione o nome do seu inquilino do Active Directory.
...
2.  Na página de início rápido **O seu modelo foi adicionado**, clique em **Começar** no passo 1, **Configurar os direitos dos utilizadores e grupos,** clique em **COMEÇAR AGORA** ou **ADICIONAR** e, em seguida, selecione os utilizadores e grupos que irão ter o direito a utilizar os conteúdos protegidos pelo novo modelo.
    ...
    > 
    > Em caso de alteração de um endereço de e-mail depois de selecionar o utilizador ou o grupo e guardar o modelo, veja a secção [Considerações em caso de alteração do endereço de e-mail](../plan-design/prepare.md#considerations-for-azure-information-protection-if-email-addresses-change) da documentação de planeamento. 
