...
|**IPC_VIEW_RIGHTS** <br><br> Sem descrição <br><br> **Pontos de Imposição Comuns**: N/D|Imposto pelo sistema. O sistema não permitirá que o programador consulte a [**lista de direitos de utilizador**](https://msdn.microsoft.com/library/hh535286.aspx) de uma licença, exceto se este direito estiver concedido.
