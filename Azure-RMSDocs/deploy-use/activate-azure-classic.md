...
description: "Utilize estas instruções se tiver acesso ao portal do Azure. Por exemplo, tem uma subscrição para o Enterprise Mobility Suite ou a subscrição Azure Rights Management Premium."
author: cabailey
manager: mbaldwin
ms.date: 06/27/2016
ms.topic: article
