...
Antes de poder chamar quaisquer funções do SDK RMS 2.1, tem primeiro de chamar a função [**IpcInitialize**](/information-protection/sdk/2.1/api/win/functions#msipc_ipcinitialize) para carregar o MSIPC.dll.
...
Esta chamada irá obter modelos de RMS instalados no servidor predefinido e carregar os resultados na estrutura [**IPC\_TIL** ](/information-protection/sdk/2.1/api/win/functions#msipc_ipcinitialize) indicada pela variável *pcTil* e, em seguida, apresentar os modelos.
...
Com vista à simplicidade, utilize o primeiro modelo de RMS devolvido por [**IpcGetTemplateList**](/information-protection/sdk/2.1/api/win/functions#msipc_ipcgettemplatelist) para serializar uma licença.
