...
## <a name="summary"></a>Resumo
 Membros                        | Descrições                                
--------------------------------|---------------------------------------------
bool pública AccessCheck | Verifica se a política concede acesso de utilizador para a direita especificado.
...
std::shared_ptr pública < TemplateDescriptor > GetTemplateDescriptor std::shared_ptr pública < PolicyDescriptor > GetPolicyDescriptor pública std::string GetOwner | Obtém endereço de e-mail do proprietário do conteúdo.
...
pública const std::vector < char não assinados > GetSerializedPolicy pública std::shared_ptr < rmscore::core::ProtectionPolicy > GetImpl
