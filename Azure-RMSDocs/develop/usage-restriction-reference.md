...
|Nenhum direito do AD RMS <br><br> Sem descrição <br><br> **Pontos de Imposição Comuns**: Alt+PrtScn|Chame [**IpcProtectWindow**](/information-protection/sdk/2.1/api/win/functions#msipc_ipcprotectwindow) em todas as janelas que componham conteúdo de documentos.|
...
|**IPC_VIEW_RIGHTS** <br><br> Sem descrição <br><br> **Pontos de Imposição Comuns**: N/D|Imposto pelo sistema. O sistema não permitirá que o programador consulte a [**lista de direitos de utilizador**](/information-protection/sdk/2.1/api/win/structures#msipc_ipc_user_rights_list) de uma licença, exceto se este direito estiver concedido.
