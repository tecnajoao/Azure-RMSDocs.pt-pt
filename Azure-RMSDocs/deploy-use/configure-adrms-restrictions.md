...
Para configurar uma etiqueta para a proteção do HYOK, consulte [como configurar uma etiqueta para proteção do Rights Management](../deploy-use/configure-policy-protection.md). 
