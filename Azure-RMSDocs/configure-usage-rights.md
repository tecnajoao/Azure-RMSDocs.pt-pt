...
Quando o Exchange Online usa os novos recursos para encriptação de mensagens do Office 365, uma nova opção de e-mail torna-se disponíveis: **Encrypt-Only**.

Esta opção está disponível para inquilinos que utilizam o Exchange Online e podem ser selecionados no Outlook na web, como outra opção direitos de proteção para uma regra de fluxo de correio, como uma ação de DLP do Office 365 e do Outlook (versão mínima do [1804](/officeupdates/monthly-channel-2018#outlook-feature-updates-4) para O Office 365 ProPlus e a versão mínima do 1805 quando tiver [aplicações do Office 365 que suportam o Azure RMS](requirements-applications.md#windows-computers-for-information-rights-management-irm). Para obter mais informações sobre a opção de criptografar apenas, consulte o seguinte anúncio de mensagem de blogue da equipa do Office: [Criptografar apenas serem implementadas na encriptação de mensagens do Office 365](https://aka.ms/omefeb2018).
