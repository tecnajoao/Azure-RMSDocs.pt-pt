...
## <a name="using-information-protection-with-the-rights-management-sharing-application"></a>Utilizar a proteção de informações com a aplicação de partilha Rights Management
