...
|Nome comum: **Responder** <br /><br />Codificação na política: **REPLY**|Ativa a opção **Responder** num cliente de e-mail, sem permitir alterações nas linhas **Para** ou **Cc**.<br /><br />Nota: quando envia um e-mail para outra organização, o cliente do Outlook ou do Outlook Web App do destinatário requer o direito **Editar Conteúdo, Editar** (nome comum), além de Responder.|Direitos personalizados do Office: não aplicável.<br /><br />Nome no portal clássico do Azure: **Responder**<br /><br />Nome em modelos do AD RMS: **Responder** <br /><br />Valor ou constante de API: `IPC_EMAIL_REPLY`|
|Nome comum: **Responder a Todos** <br /><br />Codificação na política: **REPLYALL**|Ativa a opção **Responder a Todos** num cliente de e-mail, mas não permite que o utilizador adicione destinatários às linhas **Para** ou **Cc**.<br /><br />Nota: quando envia um e-mail para outra organização, o cliente do Outlook ou do Outlook Web App do destinatário requer o direito **Editar Conteúdo, Editar** (nome comum), além de Responder a Todos.|Direitos personalizados do Office: não aplicável.<br /><br />Nome no portal clássico do Azure: **Responder a Todos**<br /><br />Nome em modelos do AD RMS: **Responder a Todos** <br /><br />Valor ou constante de API: `IPC_EMAIL_REPLYALL L"REPLYALL"`|
...
|---------------------|----------------|---------------------------------|
|Visualizador|Portal clássico do Azure<br /><br />Aplicação de partilha Rights Management para Windows<br /><br />Cliente do Azure Information Protection para Windows|Ver, Abrir, Ler; Responder; Responder a Todos<br /><br />Nota: não utilize este nível de permissão para Responder ou Responder a Todos quando envia um e-mail para outra organização e o destinatário utilizar o Outlook ou o Outlook Web App. Em alternativa, utilize Revisor, que inclui o direito **Editar Conteúdo, Editar** (nome comum), que estes clientes de e-mail requerem para responder.|
