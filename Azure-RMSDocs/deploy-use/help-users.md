...
description: "Informações para fornecer orientações a utilizadores, administradores e suporte técnico após ter implementado e configurado o Azure Rights Management (Azure RMS) para a sua organização."
author: cabailey
manager: mbaldwin
ms.date: 08/25/2016
ms.topic: article
