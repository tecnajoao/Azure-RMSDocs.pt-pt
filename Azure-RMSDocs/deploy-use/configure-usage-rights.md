...
ms.suite: ems
ms.openlocfilehash: dbc7bd92b13d3448d75b99eac82ddef0de4b0d00
...
|Nome comum: **Ver, Abrir, Ler** <br /><br />Codificação na política: **VIEW**|Permite que o utilizador abra o documento e veja o conteúdo.|Direitos personalizados do Office: como a política personalizada **Ler**, opção **Ver**.<br /><br />Nome no portal clássico do Azure: **Ver**<br /><br />Nome no portal do Azure: **ver, abrir, ler (vista)**<br /><br />Nome em modelos do AD RMS: **Responder a Todos** <br /><br />Valor ou constante de API: `IPC_GENERIC_READ L"VIEW"`|
