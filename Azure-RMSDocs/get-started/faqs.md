...
> [!TIP] Pode utilizar a [etiqueta Docs](http://blogs.technet.com/b/rms/archive/tags/docs/) no blogue, para encontrar mais facilmente estes anúncios de documentação.
