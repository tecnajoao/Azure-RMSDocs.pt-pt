...
> 
> - Os dispositivos móveis adequam-se à utilização de um serviço na cloud, pelo que, por predefinição, utilizam a deteção de serviço para o serviço Azure Rights Management (https://discover.aadrm.com). Para substituir esta predefinição, para que os dispositivos móveis utilizarem o AD RMS em vez do serviço Azure Rights Management, especifique os registos SRV no DNS e instale a extensão de dispositivos móveis, conforme documentado no [dispositivos do Active Directory Rights Management serviços móveis Extensão](https://technet.microsoft.com/library/dn673574\(v=ws.11\).aspx). 
>
