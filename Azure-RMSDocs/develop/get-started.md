...
ms.locfileid: "53023367"
---
# <a name="get-started"></a>Introdução

Para esta versão do Microsoft Rights Management SDK 4.2, a abordagem de início rápido a uma primeira aplicação é por meio de guias de configuração do ambiente de desenvolvimento para cada um dos sistemas operativos / plataformas. Comece a criar a aplicação com direitos ativados da seguinte forma:
...
4. Para obter **notas de versão** importantes e **orientações para programadores**, consulte o tópico [Novidades](release-notes.md).
  ...
  |Tópico|Descrição|
  |-----|-----------|
  |[Novidades](release-notes.md)|SDK MS RMS 4.2 leva aplicação RMS para um novo nível de facilidade e flexibilidade.|
  ...
  |[Exemplos de código](code-examples.md)|SDK MS RMS 4.2 inclui código de exemplo e projetos de trabalho para alguns sistemas operativos suportados.|
